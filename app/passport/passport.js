...
module.exports = function (app, passport){
	...
	passport.use(new FacebookStrategy({
		...
		callbackURL: "https://mean-stack-new.herokuapp.com/auth/facebook/callback",
	...
	passport.use(new TwitterStrategy({
	    ...
	    callbackURL: "https://mean-stack-new.herokuapp.com/auth/twitter/callback",
	...
	passport.use(new GoogleStrategy({
	    ...
	    callbackURL: "https://mean-stack-new.herokuapp.com/auth/google/callback"
	  },
	  function(accessToken, refreshToken, profile, done) {
	       console.log(profile.emails[0].value);
	       User.findOne({ email: profile.emails[0].value }).select('username active password email').exec(function(err, user){
